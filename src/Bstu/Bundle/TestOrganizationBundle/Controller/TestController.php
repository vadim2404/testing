...
class TestController extends Controller
{
     ...
     * @Method("POST")
     * @Template("BstuTestOrganizationBundle:Test:new.html.twig")
     */
    ...
    */
    ...
    {
        $form = $this->createForm('bstu_bundle_testorganizationbundle_test', $entity, array(
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BstuTestOrganizationBundle:Test:edit.html.twig")
     */
