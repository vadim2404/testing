...
use Bstu\Bundle\TestingBundle\Entity\Pulpit;
use Bstu\Bundle\TestingBundle\Form\PulpitType;
...
class PulpitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BstuTestingBundle:Pulpit')->findAll();
     ...
     * @Method("POST")
     * @Template("BstuTestingBundle:Pulpit:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BstuTestingBundle:Pulpit')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BstuTestingBundle:Pulpit:edit.html.twig")
     */
