...
use Bstu\Bundle\TestingBundle\Form\FacultyType;
...
class FacultyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BstuTestingBundle:Faculty')->findAll();
     ...
     * @Method("POST")
     * @Template("BstuTestingBundle:Faculty:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BstuTestingBundle:Faculty')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BstuTestingBundle:Faculty:edit.html.twig")
     */
